...
// Auth information
global.pairNumber = "2349065538089";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["2349065538089"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["2349065538089"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["2349065538089"];
global.OwnerName = process.env.OWNER_NAME || "Mia";
